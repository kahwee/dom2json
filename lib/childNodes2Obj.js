...
var _slicedToArray = function () { function sliceIterator (arr, i) { var _arr = []
    var _n = true
    var _d = false
    var _e = undefined
  ...
  Array.apply(null, childNodes).forEach(function (node) {
    if (node.nodeType === NodeType.TEXT_NODE) {
      ...
      if (typeof node.nodeValue !== 'undefined') {
        ret.$attrs = {}(0, _getProcessingNodeAttributes2.default)(node.nodeValue).forEach(function (regexValues) {
          var _regexValues = _slicedToArray(regexValues, 2)

          var key = _regexValues[0]
          var value = _regexValues[1]
